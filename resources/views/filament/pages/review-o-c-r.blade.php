        ...
        <div>
            ...
            <div
                x-data="{
                    ...
                    init() {
                        ...
                        // Setiap kali 'ocr' berubah (dari Livewire atau diubah manual via JS), render ulang highlight
                        ...
                        this.$wire.on('ocr-loaded', ({ ocr, extracted_fields }) => {
                            ...
                            // Pastikan urutan ini benar: update annotations dulu baru ocr, atau bisa dibalik
                        ...
                        // Agar ini berjalan setelah DOM siap dan Alpine menginisialisasi x-html
                        this.$nextTick(() => {
                            ...
                            if (ocrContentDivEl) {
                                ...
                                // Jika ocr sudah ada dari entangle awal
                                if (this.ocr) {
            ...
            >
                ...
                <div
                    ...
                    x-html="ocr" {{-- x-html di sini akan merender konten OCR --}}
                ></div>
    
                {{-- Hidden input untuk annotations. Kita pakai x-model langsung ke Alpine property --}}
                {{-- Pastikan ini adalah input text atau textarea agar string JSON valid --}}
