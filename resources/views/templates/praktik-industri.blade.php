...
<x-surat>
  ...
  <div class="body-main">
    ...
    <p class="justify">Untuk melakukan kegiatan Praktik Industri di {{ $perusahaan }} selama {{ floor($totalMonth) }} bulan dari tanggal {{ $start->locale('id')->translatedFormat('j F Y') }} s.d. {{ $end->locale('id')->translatedFormat('j F Y') }}, dengan dosen pembimbing : {{ $dospem }}</p>
